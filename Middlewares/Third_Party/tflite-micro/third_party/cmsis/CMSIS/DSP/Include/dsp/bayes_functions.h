 ...
 *
 * @param[in]  S                        points to a naive bayes instance
 * structure
 * @param[in]  in                       points to the elements of the input
 * vector.
 * @param[out] *pOutputProbabilities    points to a buffer of length
 * numberOfClasses containing estimated probabilities
 * @param[out] *pBufferB                points to a temporary buffer of length
 * numberOfClasses
...
uint32_t arm_gaussian_naive_bayes_predict_f32(
    ...
    float32_t *pOutputProbabilities, float32_t *pBufferB);
