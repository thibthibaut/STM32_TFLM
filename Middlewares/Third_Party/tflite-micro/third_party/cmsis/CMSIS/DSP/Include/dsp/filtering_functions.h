...
typedef struct {
  float32_t coeffs[8]
                  [4]; /**< Points to the array of modified coefficients.  The
...
/**
  @brief         Compute new coefficient arrays for use in vectorized filter
  (Neon only).
  @param[in]     numStages         number of 2nd order stages in the filter.
  @param[in]     pCoeffs           points to the original filter coefficients.
  @param[in]     pComputedCoeffs   points to the new computed coefficients for
...
/**
  ...
  @param[in]     phi      autocovariance vector starting with lag 0 (length is
  nbCoefs + 1)
  ...
  @return        none
 */
void arm_levinson_durbin_f32(const float32_t *phi, float32_t *a, float32_t *err,
                             int nbCoefs);
...
/**
  ...
  @return        none
 */
void arm_levinson_durbin_q31(const q31_t *phi, q31_t *a, q31_t *err,
                             int nbCoefs);
