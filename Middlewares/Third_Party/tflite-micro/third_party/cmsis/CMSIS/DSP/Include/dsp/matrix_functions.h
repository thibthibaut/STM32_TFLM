...
/**
 * @brief Floating-point Cholesky decomposition of Symmetric Positive Definite
 * Matrix.
 * @param[in]  src   points to the instance of the input floating-point matrix
 * structure.
 * @param[out] dst   points to the instance of the output floating-point matrix
 * structure.
 * @return The function returns ARM_MATH_SIZE_MISMATCH, if the dimensions do not
 * match. If the input matrix does not have a decomposition, then the algorithm
 * terminates and returns error status ARM_MATH_DECOMPOSITION_FAILURE. If the
 * matrix is ill conditioned or only semi-definite, then it is better using the
 * LDL^t decomposition. The decomposition is returning a lower triangular
 * matrix.
 */
arm_status arm_mat_cholesky_f64(const arm_matrix_instance_f64 *src,
                                arm_matrix_instance_f64 *dst);
 ...
 * matrix.
 */
arm_status arm_mat_cholesky_f32(const arm_matrix_instance_f32 *src,
                                arm_matrix_instance_f32 *dst);
 ...
 * @return The function returns ARM_MATH_SINGULAR, if the system can't be
 * solved.
 */
...
/**
 * @brief Floating-point LDL decomposition of Symmetric Positive Semi-Definite
 * Matrix.
 * @param[in]  src   points to the instance of the input floating-point matrix
 * structure.
 * @param[out] l   points to the instance of the output floating-point
 * triangular matrix structure.
 * @param[out] d   points to the instance of the output floating-point diagonal
 * matrix structure.
 * @param[out] p   points to the instance of the output floating-point
 * permutation vector.
 * @return The function returns ARM_MATH_SIZE_MISMATCH, if the dimensions do not
 * match. If the input matrix does not have a decomposition, then the algorithm
 * terminates and returns error status ARM_MATH_DECOMPOSITION_FAILURE. The
 * decomposition is returning a lower triangular matrix.
 */
