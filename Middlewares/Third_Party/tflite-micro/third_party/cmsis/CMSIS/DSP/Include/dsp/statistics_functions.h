 ...
 * buffer.
 */
void arm_absmin_q7(const q7_t *pSrc, uint32_t blockSize, q7_t *result,
                   uint32_t *index);
 ...
 * buffer.
 */
void arm_absmin_q15(const q15_t *pSrc, uint32_t blockSize, q15_t *pResult,
                    uint32_t *pIndex);
 ...
 * buffer.
 */
void arm_absmin_q31(const q31_t *pSrc, uint32_t blockSize, q31_t *pResult,
                    uint32_t *pIndex);
 ...
 * buffer.
 */
void arm_absmin_f32(const float32_t *pSrc, uint32_t blockSize,
 ...
 * @param[out] pIndex     index of maximum value returned here
 */
void arm_absmax_q7(const q7_t *pSrc, uint32_t blockSize, q7_t *pResult,
                   uint32_t *pIndex);
 ...
 * @param[out] pIndex     index of maximum value returned here
 */
void arm_absmax_q15(const q15_t *pSrc, uint32_t blockSize, q15_t *pResult,
                    uint32_t *pIndex);
 ...
 * @param[out] pIndex     index of maximum value returned here
 */
void arm_absmax_q31(const q31_t *pSrc, uint32_t blockSize, q31_t *pResult,
                    uint32_t *pIndex);
 ...
 * @param[out] pIndex     index of maximum value returned here
 */
void arm_absmax_f32(const float32_t *pSrc, uint32_t blockSize,
                    float32_t *pResult, uint32_t *pIndex);
