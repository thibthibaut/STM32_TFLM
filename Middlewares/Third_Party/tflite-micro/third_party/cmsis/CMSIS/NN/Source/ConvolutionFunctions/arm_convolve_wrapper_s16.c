 ...
 * Description:  s16 convolution layer wrapper function with the main purpose to
 * call the optimal kernel available in cmsis-nn to perform the convolution.
 *
 * $Date:        11 August 2021
 * $Revision:    V.1.1.0
 *
