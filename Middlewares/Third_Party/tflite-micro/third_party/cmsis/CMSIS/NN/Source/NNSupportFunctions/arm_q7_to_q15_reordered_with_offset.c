 ...
 * Description:  Converts the elements of the Q7 vector to a reordered Q15
 * vector with an added offset. The re-ordering is a signature of sign extension
 * intrinsic(DSP extension).
 *
 * $Date:        May 29, 2020
 * $Revision:    V.2.0.3
 *
...
/**
 * @brief Converts the elements of the Q7 vector to a reordered Q15 vector with
 * an added offset.
 *
